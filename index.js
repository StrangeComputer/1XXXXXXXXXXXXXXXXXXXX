...
if(command === ""){
    let authcode = [`очень жаль, но ты мудила`,`ну ты и объебок`,`а ты хуесос однако `,`ты похуже Гитлера`,`шкила, та ещё шкила..`,`ебать ты горячий как в печке`,`у тебя аутизм?`,`я тут ебалась, а ты помешал`,`ну и жирный, ахах`,`ты отброс? ну давай отбросим эти все факты и поедем ко мне`,`вы подо мной`,`я бы с тобой на парад эщкере не пошла`,`долбаеб обращается ко мне, помогите`,`чёртила ходячья`,`ты моя ссанина`,`ты херокрушитель бомжеватый`,`ты быдлоголовик настольный`,`ты килозад педантичный`,`ты губокрыс пикантный`,`ты киберпотам деспотичный`,`ты глистогенерал сопливый`,`ты дристогриль агрессивная`,`ты нанопаук въебанный`,`ты стремноман сучарный`,`ты членопуз глупый`,`ты пиздооксидант помешанный`,`ты говножитель опрометчивый`,`ты крысотехник кирпичный`,`ты залуподроид тропический`];
